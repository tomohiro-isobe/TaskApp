package jp.techacademy.isobe.tomohiro.taskapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public final static String EXTRA_TASK = "jp.techacademy.isobe.tomohiro.taskapp.TASK";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // リロード
        reload = (Button) findViewById(R.id.reload_button);
    ...
    private void reloadListView() {
        ...
        // Realmデータベースから「全てのデータを取得して新しい日時順に並べた結果を取得」
